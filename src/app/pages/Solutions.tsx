      ...
      <section className="bg-[#f5f0ff] py-24">
        <div className="max-w-[1440px] mx-auto px-8">
          <div className="text-center mb-16">
            ...
            <h1 className="font-['Plus_Jakarta_Sans',sans-serif] font-extrabold text-[72px] leading-[72px] text-[#2d2f2c] mb-6">
              Comprehensive Play
              <br />
          ...
          <div className="grid grid-cols-2 gap-8 mb-24">
            <div className="bg-[#f5f0ff] rounded-[32px] overflow-hidden">
              <div className="p-12">
                ...
                <h3 className="font-['Plus_Jakarta_Sans',sans-serif] font-bold text-[36px] text-[#2d2f2c] mb-4">
        ...
        <div className="max-w-[1440px] mx-auto px-8">
          ...
          <div className="grid grid-cols-3 gap-8">
            <div className="bg-white rounded-[24px] p-8 shadow-sm">
              <h4 className="font-['Plus_Jakarta_Sans',sans-serif] font-bold text-[24px] text-[#2d2f2c] mb-3">
        ...
        <div className="max-w-[1440px] mx-auto px-8">
          ...
          <div className="grid grid-cols-4 gap-6">
            <div className="bg-white border-b-4 border-[#a8d7ff] rounded-[24px] p-8 shadow-sm">
              ...
              <h4 className="font-['Plus_Jakarta_Sans',sans-serif] font-bold text-[20px] text-[#2d2f2c] mb-3">
                Discovery Call
              </h4>
